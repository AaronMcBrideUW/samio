...
namespace sioc::dma::ref 
{
  ...
  inline constexpr uint32_t max_td_inst = 128;
  ...
  inline constexpr std::array<uint32_t, DMAC_LVL_NUM>            prilvl_map = {1, 2, 3, 4};
  inline constexpr std::array<uint32_t, DMAC_LVL_NUM>            squal_map  = {1, 2, 3, 4};
